...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Color buttonColor = mapGameColors[GameState.readyToStart]!;
  ...
  void _changeButtonColor() {
    setState(() {
      buttonColor = mapGameColors[gameState]!;
    });
  }
...
Map<GameState, Color> mapGameColors = {
  GameState.readyToStart: const Color(0xFF40CA88),
  GameState.waiting: const Color(0xFFE0982D),
  GameState.canBeStopped: const Color(0xFFE02D47),
};
